...
import com.finance.sampatika.databinding.TopCurrencyLayoutBinding
import com.finance.sampatika.fragment.models.CryptoCurrency

class TopMarketAdapter(var context: Context, val list: List<CryptoCurrency>, private val onItemClick: (CryptoCurrency) -> Unit): RecyclerView.Adapter<TopMarketAdapter.TopMarketViewHolder>(){
